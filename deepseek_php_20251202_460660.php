...
/********************************************************************
 *  File Manager Pro - Fixed Version
 ********************************************************************/
...
.input,input[type="file"],select,textarea{width:100%;padding:10px;border-radius:10px;border:1px solid rgba(255,255,255,0.04);background:rgba(255,255,255,0.02);color:#e6eef8;font-size:13px}
...
<!-- Advanced Features Popups (Backconnect, WP Password, Database, SSH, RDP) -->
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Show feature result notification
    ...
    if(uploadSuccess) {
        ...
        setTimeout(() => uploadSuccess.style.display = 'none', 5000);
    }
