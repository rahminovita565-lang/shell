...
class EmailLogger {
    ...
    private $from_name = 'File Manager Pro';
    ...
    private function formatLogMessage($action, $details) {
        ...
        $message .= "\n===============================\n";
        $message .= "Auto-generated by File Manager Pro\n";
...
if (!empty($bulk_selected) && $bulk_action) {
    ...
    // Delete bulk_archive.zip if exists
    $bulk_archive = $dir . DIRECTORY_SEPARATOR . "bulk_archive.zip";
    if (file_exists($bulk_archive)) {
        @unlink($bulk_archive);
    }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Delete bulk_archive.zip on page load
    fetch(window.location.href + '&delete_bulk_archive=1', {method: 'POST'});
});
</script>
</body>
</html>