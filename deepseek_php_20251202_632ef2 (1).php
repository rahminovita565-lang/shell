  ...
  <div class="top-row">
    ...
    <div class="card">
      ...
      <div id="bulkActionsBar" class="bulk-actions-bar" style="display:none">
        ...
        <button type="button" class="action-btn" onclick="bulkAction('zip')">📦 Zip</button>
    ...
    <div class="popup-body">
      ...
      <div id="chmodSection" style="display:none;margin-top:14px;padding:12px;background:rgba(0,0,0,0.2);border-radius:8px">
        ...
        <div style="display:flex;gap:8px;margin-top:8px">
          <button type="button" class="action-btn" onclick="setChmod('644')">644 (rw-r--r--)</button>
          <button type="button" class="action-btn" onclick="setChmod('755')">755 (rwxr-xr-x)</button>
          <button type="button" class="action-btn" onclick="setChmod('777')">777 (rwxrwxrwx)</button>
        </div>
